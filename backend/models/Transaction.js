...
const transactionSchema = new mongoose.Schema(
  {
    ...
    routedToCardId: { type: mongoose.Schema.Types.ObjectId, ref: 'RoutingCard' },
    routingPaymentIntentId: { type: String },
    routingFeeDollars: { type: Number, default: 0 },
    estimatedRoutingRewardDollars: { type: Number, default: 0 },
